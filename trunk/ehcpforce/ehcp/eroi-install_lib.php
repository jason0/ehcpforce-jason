...
Some install/usage info and your name/email is sent to ehcp developpers for statistical purposes and for improvements.";
	...
	# jason: this next line might be the best place to pass in any custom dirs...
	# the constructor doesn't take variables passed into it.  Apparently at least...
	...
	switch($installmode) {
		...
		case 'light': aptget(array('openssh-server','python-mysqldb','python-cherrypy3','apache2','php5-gd','libapache-mod-ssl'));
			break;
		default: echo "Unknown installmode parameter at ".__LINE__;
	}

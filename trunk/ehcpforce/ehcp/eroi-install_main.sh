...
#############################################################
installdir=$(pwd)
if [ ! -f $installdir/eroi-install.sh ] ; then
	echo "eroi-install.sh is not in install dir. Run install.sh from within ehcp installation dir."
	exit 1
fi
...
echo "STAGE 2"
echo "====================================================================="
echo "now running eroi-install_1.php "
#infoMail ehcp_2_install-starting-install_1.php
php eroi-install_1.php $version $distro $noapt $unattended $installmode

echo
echo
echo "STAGE 3"
echo "====================================================================="
echo "now running eroi-install_2.php "
...
php eroi-install_2.php $version $distro $noapt $unattended $installmode
